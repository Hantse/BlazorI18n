...
namespace BlazorI18n.Core.Helpers
{
    public class JsonHelper
    {
        ...
        public static Dictionary<string, string> Flatten(string jsonObject)
        {
            return Flatten(JObject.FromObject(JsonConvert.DeserializeObject(jsonObject)));
        }

        public static Dictionary<string, string> Flatten(object jsonObject)
        {
            return Flatten(JObject.FromObject(jsonObject));
        }
